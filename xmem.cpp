...
namespace xmem {
    ...
    Serial.println(F("Writing to RAM"));
		...
		for(bank=0;bank<1;bank++) {
			...
			for(ptr=reinterpret_cast<uint8_t *> (0x7FFF);ptr>=reinterpret_cast<uint8_t *> (0x2200);ptr--) {
				*ptr=writeValue;
...
//        Serial.println(writeValue);
		...
		// verify the writes
    Serial.println(F("Reading from RAM"));
